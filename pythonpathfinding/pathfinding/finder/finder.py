...
from pythonpathfinding.pathfinding.core.heuristic import manhatten, octile
from pythonpathfinding.pathfinding.core.util import SQRT2
...
class Finder(object):
    def __init__(self, heuristic=None, weight=1,
        ...
        self.targets_collected =[0,0,0,0,0,0]
    ...
    def find_path(self, start, bottype , grid):
        """
        ...
        while len(open_list) > 0:
            ...
            path = self.ids(start, bottype, grid, open_list)
            if path:
